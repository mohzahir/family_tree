<div class="navbar-wrapper">
    ...
    <div class="collapse navbar-collapse" id="navbar-mobile">
        ...
        <li class="nav-item d-none d-md-block"><a class="nav-link nav-menu-main menu-toggle hidden-xs" href="{{ route('family.home') }}"><i class="ft-menu"></i> الذهاب الى الموقع</a></li>
        ...
        {{--<li class="dropdown nav-item mega-dropdown"><a class="dropdown-toggle nav-link" href="#" data-toggle="dropdown">Mega</a>
            ...
            <li class="col-md-2">
                ...
                <div>
                    <img class="rounded img-fluid mb-1" src="../../../template/app-assets/images/slider/slider-2.png"
