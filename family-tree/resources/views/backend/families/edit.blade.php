<x-app-layout>
    ...
    <x-slot name="header">
        <div class="content-header-left col-md-6 col-12 mb-2">
            ...
            <h3 class="content-header-title mb-0">تعديل اسرة ({{ $family->father->name }})</h3>
        </div>
                ...
                <div class="card">
                    ...
                    <div class="card-content">
                        <div class="card-body">
                            ...
                            <form action="{{route('family.update', $family->id)}}" method="POST" class="form">
                                @csrf
                                @method('PATCH')
                                <div class="form-body">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <select x-init="$($el).select2()" data-tags="true" type="text" class="form-control w-100" name="father_id">
                                                            ...
                                                            @foreach($males as $male)
                                                                <option value="{{$male->id}}" {{ $male->id == $family->father->id ? 'selected' : ''}} > {{$male->name}} </option>
                                                            @endforeach
                                                        </select>
                                                    </div>
                                                </div>
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <select x-init="$($el).select2()" data-tags="true" class="form-control w-100" name="mother_id">
                                                            ...
                                                            @foreach($females as $female)
                                                                <option value="{{$female->id}}" {{ $female->id == $family->mother->id ? 'selected' : ''}} >{{$female->name}}</option>
                                                            @endforeach
                                                        </select>
                                                    </div>
                                                </div>
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <select type="text" class="form-control" name="city_id" >
                                                            ...
                                                            @foreach($cities as $city)
                                                                <option value="{{$city->id}}" {{$family->city_id == $city->id ? 'selected' : ''}}>{{$city->name}}</option>
                                                            @endforeach
                                                        </select>
                                                    </div>
                                                </div>
                                            ...
                                            <div class="row">
                                                <div class="col-md-12">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="date" class="form-control" value="{{ $family->marriage_date }}" name="marriage_date">
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="row">
                                                <div class="col-12">
                                                    ...
                                                    <textarea id="" rows="5" class="form-control" name="note">{{ $family->note }}</textarea>
                                                </div>
                                            </div>
                                            <div class="row mt-3">
                                                <div class="col-md-3 d-flex align-items-center">
                                                    <div class="form-group">
                                                        <input type="checkbox" x-init="$el.checked = {{ $family->is_divorced }}; is_divorced = {{ $family->is_divorced }}" @change=" is_divorced = $el.checked" class="checkbox mr-1" name="is_divorced">
                                                ...
                                                <div x-show="is_divorced" x-transition class="col-md-9">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="date" class="form-control" value="{{ $family->divorce_date }}" name="divorce_date">
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                                ...
                                                <div  class="col-md-6">
                                                    <div class="d-flex justify-content-center align-items-end">
                                                        <div>
                                                            ...
                                                            <input type="number" x-ref="sons_count" value="{{ $family->sons_count }}" class="form-control" name="sons_count">
                                                        </div>
                                                        <div>
                                                    ...
                                                    <div x-ref="sons_container">
                                                        @foreach($family->sons()->where('gender', 'male')->get() as $son)
                                                        <div class='form-group mt-2'>
                                                            <select  x-init='$($el).select2()' data-tags='true' type='text' placeholder='ادخل الاسم' class='form-control' style="width: 100% !important;" name='sons[]'>
                                                                <option value=''>اختر الابن</option>
                                                                    @foreach($males as $male)
                                                                    <option value='{{ $male->id }}' {{ $son->id == $male->id ? 'selected' : '' }} >{{ $male->name }}</option>
                                                                    @endforeach
                                                            </select>
                                                        </div>
                                                        @endforeach
                                                ...
                                                <div class="col-md-6">
                                                    <div class="d-flex justify-content-center align-items-end">
                                                        <div>
                                                            ...
                                                            <input type="number" x-ref="daughters_count" value="{{ $family->daughters_count }}" class="form-control" name="daughters_count">
                                                        </div>
                                                        <div>
                                                    ...
                                                    <div x-ref="daughters_container">
                                                        @foreach($family->sons()->where('gender', 'female')->get() as $daughter)
                                                        <div class='form-group mt-2'>
                                                            <select  x-init='$($el).select2()' data-tags='true' type='text' placeholder='ادخل الاسم' class='form-control' style="width: 100% !important;" name='daughters[]'>
                                                                <option value=''>اختر الابن</option>
                                                                    @foreach($females as $female)
                                                                    <option value='{{ $female->id }}' {{ $daughter->id == $female->id ? 'selected' : '' }} >{{ $female->name }}</option>
                                                                    @endforeach
                                                            </select>
                                                        </div>
                                                        @endforeach
